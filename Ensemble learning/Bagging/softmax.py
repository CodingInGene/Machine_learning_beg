...
class Softmax:
    ...
    def fit(self,x,y,learning_rate,epochs,batch_size):
        ...
        self.weights=np.zeros([y.shape[1],x.shape[1]])  # no of classes x no of features+1
        ...
        for i in range(0,self.epochs):
            ...
            '''
            self.slope = np.dot(np.transpose(y[batch] - y_hat),x[batch])
...
if __name__=="__main__":
    ...
    #Training
    softmax.fit(xtrain_new,y_encoded,learning_rate=0.05,epochs=9000,batch_size=30)
